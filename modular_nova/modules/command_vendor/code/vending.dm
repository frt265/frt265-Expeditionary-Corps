...
/obj/machinery/vending/access/command/build_access_list(list/access_lists)
	...
	access_lists[ACCESS_HOP] = list( // Best head btw
		...
		/obj/item/clothing/under/imperial/hop = 1,
		/obj/item/clothing/under/imperialskirt/hop = 1,
	...
	access_lists[ACCESS_CMO] = list(
		...
		/obj/item/clothing/under/imperial/cmo = 1,
		/obj/item/clothing/under/imperialskirt/cmo = 1,
	...
	access_lists[ACCESS_RD] = list(
		...
		/obj/item/clothing/under/imperial/rd = 1,
		/obj/item/clothing/under/imperialskirt/rd = 1,
	...
	access_lists[ACCESS_CE] = list(
		...
		/obj/item/clothing/under/imperial/ce = 1,
		/obj/item/clothing/under/imperialskirt/ce = 1,
	...
	access_lists[ACCESS_HOS] = list(
		...
		/obj/item/clothing/under/imperialvest/hos = 1,
		/obj/item/clothing/under/imperialskirtvest/hos = 1,
	...
	access_lists[ACCESS_QM] = list(
		...
		/obj/item/clothing/under/imperial/quartermaster = 1,
		/obj/item/clothing/under/imperialskirt/quartermaster = 1,
